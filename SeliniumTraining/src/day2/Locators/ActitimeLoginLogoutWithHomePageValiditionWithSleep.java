...
public class ActitimeLoginLogoutWithHomePageValiditionWithSleep {
	...
	public static void main(String[] args) throws InterruptedException {// bcs of Thread 
		...
		//identify the required element from the UI and perform reqiored action 0-30// for user name
		driver.findElement(By.id("username")).sendKeys("admin");
		//identify the required element from the UI and perform reqiored action 0-30//for password
		driver.findElement(By.name("pwd")).sendKeys("manager");
		//identify the required element from the UI and perform reqiored action// for login button
		driver.findElement(By.id("loginButton")).click();//0-30 sec
		
		//explicit wait -- hard coded wait
		Thread.sleep(2000);// exeption de raha tha to to import stetement ki tarah liya // explicitetly ke jagah pe use kiya 
