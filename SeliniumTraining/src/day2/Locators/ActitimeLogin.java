...
public class ActitimeLogin {
	...
	WebDriver driver=new ChromeDriver();// import statement // browser launch here
	...
	WebElement userNameInputField=driver.findElement(By.id("username"));//import// find element and stored it in webelement
