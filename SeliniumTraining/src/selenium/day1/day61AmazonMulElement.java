...
public class day61AmazonMulElement {
	...
	public static void main(String[] args) {
		...
		List<WebElement> allOptions=driver.findElements(By.cssSelector("#nav-xshop>a"));//list ke liye import java.util
		...
		driver.navigate().back();// comment karke run karo to see click
