...
public class GSMArenaPaginationSamsung {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://www.gsmarena.com/samsung-phones-9.php");// gsmArena par jakar samsung pe jakar link copy past ki hai
		...
		if(paginationLinks.size()>0) {
			...
			System.out.println("Pagination links count: "+paginationLinks.size());
		}
...
2.Click on samsung phone link present in phone finder
